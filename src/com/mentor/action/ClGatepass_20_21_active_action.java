...
public class ClGatepass_20_21_active_action {


	ClGatepass_20_21_active_impl impl = new ClGatepass_20_21_active_impl();
	...
	public void calculateTotalDuty(ActionEvent ae) {
		...
		if (isFlag()) {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) this.displaylist.get(i);
	...
	public double getDb_total_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) this.getDisplaylist().get(i);
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) displaylist.get(i);
	...
	public void printreport(ActionEvent e) {
		...
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) this.getListWholesale.get(uiTable
				.getRowIndex());
	...
	public String importExcel() {
		...
		new ClGatepass_20_21_active_impl().saveExcelData(this);
		this.bottlingNotDoneFlag = false;
		this.tableFlag = true;
	...
	public void scanAndUpload(ActionEvent ae) {
		...
		ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) this.getListWholesale.get(uiTable.getRowIndex());
	...
	public void delete() {
		...
		new ClGatepass_20_21_active_impl().deleteData(this);
