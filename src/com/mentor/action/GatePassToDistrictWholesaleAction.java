...
public class GatePassToDistrictWholesaleAction {

	GatePassToDistrictWholesaleImpl impl = new GatePassToDistrictWholesaleImpl();
...
public String tntflg="X";
	...
	public void saveconfirmation(ActionEvent e) {
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			GatePassToDistrictWholesaleDatatable dt = (GatePassToDistrictWholesaleDatatable) displaylist
					.get(i);
...
x=true;
	...
	public void calculateTotalBalance(ActionEvent ae) {
		...
		this.setSum(0);
		for (int i = 0; i < this.displaylist.size(); i++) {
			GatePassToDistrictWholesaleDatatable dt = (GatePassToDistrictWholesaleDatatable) this.displaylist
					.get(i);
	...
	public double getDb_total_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatePassToDistrictWholesaleDatatable dt = (GatePassToDistrictWholesaleDatatable) this
	...
	public ArrayList getGetListWholesale() {
		...
		if (this.listFlagForPrint == true) {
			this.getListWholesale = new GatePassToDistrictWholesaleImpl()
	...
	public void printDetail(ActionEvent e) {
		...
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		GatePassToDistrictWholesaleDatatable dt = (GatePassToDistrictWholesaleDatatable) this.getListWholesale
	...
	public String importExcel() {
		new GatePassToDistrictWholesaleImpl().saveExcelData(this);
this.bottlingNotDoneFlag=false;
	...
	public void scanAndUpload(ActionEvent ae) {
		...
		// GatePassToDistrictWholesaleDatatable dt=new
		// GatePassToDistrictWholesaleDatatable();
...
/*
	...
	public void delete() {
		...
		new GatePassToDistrictWholesaleImpl().deleteData(this);
