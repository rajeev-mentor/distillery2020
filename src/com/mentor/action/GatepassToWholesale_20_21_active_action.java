...
import com.mentor.impl.GatepassToWholesale_20_21_active_impl;
import com.mentor.utility.Constants;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Utility;
import com.mentor.utility.Validate;

public class GatepassToWholesale_20_21_active_action {

	GatepassToWholesale_20_21_active_impl impl = new GatepassToWholesale_20_21_active_impl();
	...
	private GatepassToWholesale_20_21_active_dt gptwd;
	...
	public GatepassToWholesale_20_21_active_dt getGptwd() {
		return gptwd;
	}

	public void setGptwd(GatepassToWholesale_20_21_active_dt gptwd) {
		this.gptwd = gptwd;
	}
	...
	GatepassToWholesale_20_21_active_dt gptw;
	...
	public GatepassToWholesale_20_21_active_dt getGptw() {
		return gptw;
	}

	public void setGptw(GatepassToWholesale_20_21_active_dt gptw) {
		this.gptw = gptw;
	}
	...
	public void saveconfirmation(ActionEvent e) {
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) displaylist
						.get(i);
	...
	/*
	 * public void delete() { new
	 * GatepassToWholesale_20_21_active_impl().deleteData();
	...
	public void scanAndUpload(ActionEvent ae) {
		UIDataTable uiTable = (UIDataTable) ae.getComponent().getParent()
				.getParent();
		GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) this.getListWholesale
	...
	public String listMethod(ValueChangeEvent vce) {
		...
		if (this.vch_from_lic_no == null
				|| this.vch_from_lic_no.equalsIgnoreCase(""))
			this.lic_disable_flag2 = false;
		else
	...
	public double getDb_total_add_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) this
	 ...
	 * dt=(GatepassToWholesale_20_21_active_dt) this.displaylist.get(rowId);
	 * 
	...
	public void calculateTotalDuty(ActionEvent ae) {
		...
		if (isFlag()) {
			this.setSum(0);
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) this.displaylist
						.get(i);
	...
	public String importExcel() {
		new GatepassToWholesale_20_21_active_impl().saveExcelData(this);
		this.bottlingNotDoneFlag = false;
		this.gatePassFlag = true;
		this.scanUploadFlag = true;
		this.getVal = impl.getExcelData(this);
	 ...
	 * GatepassToWholesale_20_21_active_impl().saveCSV(this);
	...
	public void lic_change(ValueChangeEvent e) {
		...
		if (this.vch_to_lic_no == null
				|| this.vch_to_lic_no.equalsIgnoreCase("0"))
			this.lic_disable_flag = false;
		else
