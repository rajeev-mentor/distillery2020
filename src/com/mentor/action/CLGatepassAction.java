...
import com.mentor.impl.CLGatepassImpl;
import com.mentor.impl.CLGatepassImpl;
...
public class CLGatepassAction {

	CLGatepassImpl impl = new CLGatepassImpl();
	...
	public double getDb_total_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				CLGatepassDT dt = (CLGatepassDT) this.getDisplaylist().get(i);
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			CLGatepassDT dt = (CLGatepassDT) displaylist.get(i);
	...
	public void printreport(ActionEvent e) {
		...
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		CLGatepassDT dt = (CLGatepassDT) this.getListWholesale.get(uiTable
				.getRowIndex());
	...
	public String importExcel() {
		...
		new CLGatepassImpl().saveExcelData(this);
		this.bottlingNotDoneFlag = false;
		this.tableFlag = true;
	...
	public void scanAndUpload(ActionEvent ae) {
		...
		CLGatepassDT dt = (CLGatepassDT) this.getListWholesale.get(uiTable.getRowIndex());
	...
	public void delete() {
		...
		new CLGatepassImpl().deleteData(this);
