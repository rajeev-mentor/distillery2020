...
import com.mentor.action.GatepassToWholesale_20_21_active_action;
import com.mentor.resource.ConnectionToDataBase;
import com.mentor.utility.Constants;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Utility;

public class GatepassToDistrictWholesale_20_21_active_impl {
	...
	public boolean  etin(String casecode,GatepassToDistrictWholesale_20_21_active_action act) {
		...
		try {
			...
			String query = " SELECT distinct b.code_generate_through FROM distillery.fl2_stock_trxn_20_21 a, distillery.packaging_details_20_21 b "
	...
	public String saveMethodImpl(GatepassToDistrictWholesale_20_21_active_action act) {
		Connection con = null;
		...
		String gatepass = String.valueOf(act.getDist_id()) + "-2020-21-FL36-"
				+ seq;
		try {
			int cases = 0;
			int totalBottles = 0;
			...
			sql = " INSERT INTO distillery.gatepass_to_districtwholesale_20_21("
			...
			if (tok1 > 0) {
				...
				for (int i = 0; i < act.displaylist.size(); i++) {
					...
					GatepassToDistrictWholesale_20_21_active_dt dt = (GatepassToDistrictWholesale_20_21_active_dt) act
							.getDisplaylist().get(i);
					if (dt.getDispatchbottls() > 0 && dt.getDispatchbox() > 0 && dt.getIndentbox()>0) {
						tok1 = 0;
						indentbox=dt.getDispatchbox();
						sql2 = " INSERT INTO distillery.fl2_stock_trxn_20_21("
			...
			if (tok1 > 0) {
				...
				String updtQr = " UPDATE distillery.fl2_stock_20_21 SET dispatch_box=COALESCE(dispatch_box,0)+"+dt.getDispatchbox()+",  dispatch_bottles=COALESCE(dispatch_bottles,0)+"+ dt.getDispatchbottls()+ " " +
			...
			for (int ii = 0; ii < act.getDisplaylist1().size(); ii++) 
			{
				...
				GatepassToDistrictWholesale_20_21_active_dt dt1 = 
						(GatepassToDistrictWholesale_20_21_active_dt) act.getDisplaylist1().get(ii);
	...
	public ArrayList displaylistImpl(GatepassToDistrictWholesale_20_21_active_action act,
			String val) {
		...
		try {
			...
			selQr = " SELECT distinct  a.package_name, a.package_id,  c.brand, b.brand_name,"
					...
					+ " distillery.fl2_stock_20_21 c, distillery.box_size_details d "
	...
	// -----------list
	public ArrayList fromliclistImpl(GatepassToDistrictWholesale_20_21_active_action act,
			String val) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		...
		list.add(item);
		try {
			String query = " SELECT distinct vch_lic_type, trim(vch_lic_no) as vch_lic_no FROM distillery.fl1_stock_trxn_20_21 "
					+ " WHERE vch_lic_type='"
					+ val
					+ "' AND int_dissleri_id='"
					+ act.getDist_id() + "' ";
	...
	public ArrayList toliclistImpl(GatepassToDistrictWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public String licenceedet(GatepassToDistrictWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		try {
			String query = "SELECT distinct int_app_id,vch_firm_name,vch_applicant_name,vch_core_address FROM licence.fl2_2b_2d_20_21 WHERE vch_license_type='FL2'  and vch_licence_no='"
	...
	public ArrayList toliclistImpl2a(GatepassToDistrictWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		list.add(item);
		try {
			String query = " SELECT distinct vch_licence_no FROM licence.fl2_2b_2d_20_21 WHERE vch_license_type='FL2'  "
	...
	public String getDetails(GatepassToDistrictWholesale_20_21_active_action ac) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public ArrayList getSeasonDetails(GatepassToDistrictWholesale_20_21_active_action ac) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public int maxId(GatepassToDistrictWholesale_20_21_active_impl impl) {

		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String query = " SELECT max(int_max_id) as id FROM distillery.gatepass_to_districtwholesale_20_21 ";
		int maxid = 0;
		try {
			con = ConnectionToDataBase.getConnection();
			pstmt = con.prepareStatement(query);
	...
	public boolean printReport(GatepassToDistrictWholesale_20_21_active_action action) {
		...
		/*	reportQuery="select vch_undertaking_name, vch_gatepass_no,vehicle_driver_name,vch_wrk_add, vch_from," +
			...
			reportQuery="select time_dt,indent_no, vch_undertaking_name, vch_gatepass_no,vehicle_driver_name,vch_wrk_add, vch_from," +
					...
					"dispatch_box ,gross_weight, tier_weight, net_weight, int_brand_id,box_size,no_bottl,brand_name," +
					" strength, package_name, box_id,ml,vch_firm_name, vch_batch_no,dt_date,bl,al  " +
					"from distillery.GatepassToDistrictWholesalePrint_20_21("+action.getDist_id()+", '"+action.getPrintGatePassNo().trim()+"' )";
	...
	public boolean printDraftReport(GatepassToDistrictWholesale_20_21_active_action action) {
		String mypath = Constants.JBOSS_SERVER_PATH + Constants.JBOSS_LINX_PATH;
		String relativePath = mypath + File.separator + "ExciseUp"
				+ File.separator + "WholeSale" + File.separator + "jasper";
		String relativePathpdf = mypath + File.separator + "ExciseUp"
	...
	public ArrayList getGatePassWholeSaleListManufacture(
			GatepassToDistrictWholesale_20_21_active_action action) {
		ArrayList list = null;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		String query = " SELECT int_dist_id, coalesce(seq_fl1,0) as seqfl11,   "
				...
				+ " distillery.gatepass_to_districtwholesale_20_21 where int_dist_id="+ action.getDist_id() + " " +
	...
	public String getEmailDetails(GatepassToDistrictWholesale_20_21_active_action ac) {
		...
		try {
			...
			String queryList = " SELECT a.officer_email "
					+ " FROM public.district a, distillery.gatepass_to_districtwholesale_20_21 b "
	...
	/*
	 * public boolean printDraftReport(GatepassToDistrictWholesale_20_21_active_action act,
	 ...
	 * }
	 */
	public void saveExcelData(GatepassToDistrictWholesale_20_21_active_action action) {
		String gatepass = "";
	...
	public void deleteData(GatepassToDistrictWholesale_20_21_active_action action) {
		Connection con = null;
	...
	public ArrayList getExcelData(GatepassToDistrictWholesale_20_21_active_action action) {
		ArrayList list = new ArrayList();
	...
	public String brand_pack(String etn){
		...
		String sql="";
			...
			sql="select brand_name,package_name from distillery.packaging_details_20_21 a,distillery.brand_registration_20_21 b" +
	...
	/*
	 * public boolean updateFL3(GatepassToDistrictWholesale_20_21_active_action act) { int
	 ...
	 * 
	 * 
	 * try { con1=ConnectionToDataBase.getConnection20_21();
	 * con1.setAutoCommit(false); con2.setAutoCommit(false); for (int i = 0; i <
	 * act.getGetVal().size(); i++) { GatepassToDistrictWholesale_20_21_active_dt dt =
	 * (GatepassToDistrictWholesale_20_21_active_dt) act .getGetVal().get(i);
	 ...
	 * }
	 */
	public boolean updateFL3(GatepassToDistrictWholesale_20_21_active_action act) {
		int save = 0;
		int save1 = 0;
		boolean val = false;
		PreparedStatement ps = null;
		...
		try {
			...
			if (act.getGetVal().size() == save && save>0) {
				save = 0;
				query = " UPDATE distillery.gatepass_to_districtwholesale_20_21	SET vch_finalize='F', finalize_dt_time=? " +
	...
	public boolean updateFL3FL11(GatepassToDistrictWholesale_20_21_active_action act) {
		int save = 0;
		int save1 = 0;
		boolean val = false;
		PreparedStatement ps = null;
	...
	public boolean getCascodeMatch(String casecode,String etin ,GatepassToDistrictWholesale_20_21_active_action act,Date date)
	{
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
	...
	public void savCSV(GatepassToDistrictWholesale_20_21_active_action action)
			throws IOException {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	public int excelCases(GatepassToDistrictWholesale_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public int recieveCases(GatepassToDistrictWholesale_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
		...
		try {
			 ...
			 */
			String query = "SELECT SUM(dispatch_box) as dispatch_box FROM distillery.fl2_stock_trxn_20_21 "
	...
	public int fl11Cases(GatepassToDistrictWholesale_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public Date maxdt(int act) {
		...
		try {
			...
			String query = "SELECT coalesce(max(dt_date),'2018-01-01') FROM distillery.gatepass_to_manufacturewholesale_20_21 "
					+ "WHERE seq=" + act + "";
	...
	public int seqCancel() {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String query = " SELECT max(seq) as id FROM distillery.gatepass_to_manufacturewholesale_20_21 ";
		int maxid = 0;
		try {
			con = ConnectionToDataBase.getConnection();
			pstmt = con.prepareStatement(query);
	...
	public String cancelGatepassImpl(GatepassToDistrictWholesale_20_21_active_action act) {
		...
		try {
			...
			while (rs.next()) {
				...
				String vch_from_lic_no=rs.getString("vch_from_lic_no");
					...
					String  updtQr = " UPDATE distillery.fl2_stock_20_21 SET dispatch_box=COALESCE(dispatch_box,0)-"+box+",  dispatch_bottles=COALESCE(dispatch_bottles,0)-"+ dt.getDispatcBotlsDt()+ " " +
			...
			if (tok1 > 0) {
				...
				sql2 = " DELETE FROM distillery.gatepass_to_districtwholesale_20_21 "
			...
			if (tok1 > 0) {
				...
				sql3 = " DELETE FROM distillery.fl2_stock_trxn_20_21 "
						+ " WHERE vch_gatepass_no='" +gatepass
	...
	public void getLicenseDetail(GatepassToDistrictWholesale_20_21_active_action action)
	{
		...
		ResultSet rs=null;
		ArrayList list=new ArrayList();
		String query1=" select vch_core_address,vch_firm_name,coalesce(b.allowed_dispatch,'D')allowed_dispatch  from licence.fl2_2b_2d_20_21,public.district b " +
				"  where b.districtid=core_district_id and  vch_licence_no='" + action.getVch_to_lic_no().trim() + "' and vch_license_type='FL2' ";
		 
		
		String query2=" select vch_core_address,vch_firm_name ,coalesce(b.allowed_dispatch,'D')allowed_dispatch  from licence.fl2_2b_2d_20_21 ,public.district b " +
				"  where b.districtid=core_district_id and  vch_licence_no='" + action.getVch_to_lic_no().trim() + "' and vch_license_type='FL2B' ";
		try
		{
	...
	public void saveCSV(GatepassToDistrictWholesale_20_21_active_action action) throws IOException {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	//------------------------------------------------------------
	public ArrayList indentDetail(GatepassToDistrictWholesale_20_21_active_action act,String val ) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList displaylistImpl2(GatepassToDistrictWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
...
boolean flag=false;
		...
		/*if (act.getVch_to().equalsIgnoreCase("FL2B")) 
		{
			...
			while (rs.next()) 
			{
				GatepassToDistrictWholesale_20_21_active_dt dt1 = new GatepassToDistrictWholesale_20_21_active_dt();
		...
		*/
			...
			System.out.println("selQr1============get data=========="+selQr1);
			...
			while (rs.next()) 
			{
				GatepassToDistrictWholesale_20_21_active_dt dt2 = new GatepassToDistrictWholesale_20_21_active_dt();
...
//----------------------------------------------------------------------------------
	  ...
	  public boolean checkDate(GatepassToDistrictWholesale_20_21_active_action act) {
			...
			try {
				...
				query =" select  vch_finalize,dt_date from distillery.gatepass_to_districtwholesale_20_21 "+
					   " where vch_finalize is  null    and "+
					   " int_dist_id='"+act.getDist_id()+"'   and  dt_date <'"+Utility.convertUtilDateToSQLDate(new Date())+"'  order by dt_date desc ";
