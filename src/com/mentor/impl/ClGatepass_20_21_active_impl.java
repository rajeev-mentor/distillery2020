...
import com.mentor.Datatable.ClGatepass_20_21_active_dt;
...
public class ClGatepass_20_21_active_impl {
	...
	public String getDetails(ClGatepass_20_21_active_action ac) {
	...
	public ArrayList getSeasonDetails(ClGatepass_20_21_active_action ac) {
	...
	public ArrayList licListFL2Impl(ClGatepass_20_21_active_action act) {
	...
	public ArrayList displaylistImpl(ClGatepass_20_21_active_action act) {
		...
		try {
			...
			rs = ps.executeQuery();
			while (rs.next()) {
				ClGatepass_20_21_active_dt dt = new ClGatepass_20_21_active_dt();
	...
	public String licenceeDetail(ClGatepass_20_21_active_action act) {
	...
	public boolean  etin(String casecode,ClGatepass_20_21_active_action act) {
	...
	public String saveMethodImpl(ClGatepass_20_21_active_action act) {
		...
		try {
			...
			if (tok1 > 0) {
				...
				for (int i = 0; i < act.displaylist.size(); i++) {
					ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) act.getDisplaylist().get(i);
					...
					if (dt.getDispatchBoxes() > 0 && dt.getInt_dispatch() > 0 && dt.getIndentbox()>0) {
						...
						for (int ii = 0; ii < act.getDisplaylist1().size(); ii++) 
						{
							...
							ClGatepass_20_21_active_dt dt1 = 
									(ClGatepass_20_21_active_dt) act.getDisplaylist1().get(ii);
				...
				if(tok1>0)
				{
					...
					String	 sql3 = " INSERT INTO distillery.duty_register_19_20( " +
							" int_id, int_distillery_id, date_crr_date, " +
							" vch_duty_type, int_quantity,  vch_description,gatepass,int_value) " +
							" VALUES (?, ?, ?, ?, ?, ?, ?,?) ";
					...
					ps4.setInt(2, act.getDistId());
					ps4.setDate(3, new java.sql.Date(System.currentTimeMillis()));
					ps4.setString(4, "CL_SOCIAL_DUTY");
					ps4.setDouble(5, totalBottles);
					ps4.setDouble(8, ceshsum);
					ps4.setString(6, "Special Additional Duty For "+totalBottles+" Bottles CL Gatepass No.");
					ps4.setString(7, gatepass);
					tok1 = ps4.executeUpdate();
	...
	public String getEmailDetails(ClGatepass_20_21_active_action ac) {
	...
	public int maxId(ClGatepass_20_21_active_impl impl) {
	...
	public ArrayList getGatePassWholeSaleListCL(ClGatepass_20_21_active_action act) {
	...
	public ArrayList districtListImpl(ClGatepass_20_21_active_action act) {
	...
	public boolean printReport(ClGatepass_20_21_active_action action) 
	{
		...
		try {
			...
			if (rs.next()) {
				...
				ClGatepass_20_21_active_dt dt1 = new ClGatepass_20_21_active_dt();
	...
	// ------------------------------------------------
	public void saveExcelData(ClGatepass_20_21_active_action action) {
		String gatepass = "";
		int status = 0;
	...
	public int excelCases(ClGatepass_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public int recieveCases(ClGatepass_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public void deleteData(ClGatepass_20_21_active_action action) {
		Connection con = null;
...
public boolean etin_check(String g) {
	...
	public boolean updateFL3(ClGatepass_20_21_active_action act) {
		int save = 0;
		int save1 = 0;
		boolean val = false;
		PreparedStatement ps = null;
		...
		try {
			...
			for (int i = 0; i < act.getGetVal().size(); i++) {
				ClGatepass_20_21_active_dt dt = (ClGatepass_20_21_active_dt) act.getGetVal().get(i);
	...
	public ArrayList getExcelData(ClGatepass_20_21_active_action action) {
		ArrayList list = new ArrayList();
	...
	public boolean getCascodeMatch(Date date1, String casecode,String etin, ClGatepass_20_21_active_action action)
	{
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
	...
	public boolean printDraftReport(ClGatepass_20_21_active_action action) {
	...
	public int maxIdSeq(ClGatepass_20_21_active_impl impl) {
	...
	/*public String cancel_gatepassImpl(ClGatepass_20_21_active_action act)
	{
...
String description="";
			...
			if(tok1 > 0){
				...
				System.out.println("inside duty loop" );
					
					 sql5 = " delete from  distillery.duty_register_19_20  where  gatepass ='"+gatepass.trim()+"'";
					 
					 ps6 = con.prepareStatement(sql5);

					 tok1= ps6.executeUpdate();
				  System.out.println("six status----------" + tok1);		 
				}
	...
	public boolean getLicenseDetail(ClGatepass_20_21_active_action action)
	{
	...
	public void saveCSV(ClGatepass_20_21_active_action action) throws IOException {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	//-------------------------------------------------------------------------------------
	public ArrayList indentDetail(ClGatepass_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList displaylistImpl2(ClGatepass_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		{ 
			...
			selQr = " SELECT a.package_name, a.cesh, a.package_id,c.vch_lic_no, a.duty, a.adduty, c.int_brand_id," +
...
//-----------------------------------------------------------------------------------
    ...
    public boolean checkDate(ClGatepass_20_21_active_action act) {
