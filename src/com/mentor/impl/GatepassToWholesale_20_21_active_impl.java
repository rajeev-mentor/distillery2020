...
public class GatepassToWholesale_20_21_active_impl {
	...
	public void deleteData(GatepassToWholesale_20_21_active_action act) {
	...
	public String saveMethodImpl(GatepassToWholesale_20_21_active_action act) {
		Connection con = null;
		...
		String gatepass = String.valueOf(act.getDist_id()) + "-2020-21-"
				+ act.getVch_from() + "-" + seq;
		...
		try {
			...
			if (act.getVch_to().equalsIgnoreCase("EXPORT")) 
			{
				...
				ps.setInt(9, 0);
				ps.setDouble(13, act.getDb_total_value_exp());
			}
		 ...
		 for (int i = 0; i < act.displaylist.size(); i++) {
				GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) act.getDisplaylist().get(i);
			...
			if(tok3>0 && !act.getVch_to().equalsIgnoreCase("EXPORT") || !act.getVch_to().equalsIgnoreCase("EOI") ||!act.getVch_to().equalsIgnoreCase("FL2A"))
			{
				tok3=0;
				...
				ps3.setInt(2, act.getDist_id());
				ps3.setDate(3, new java.sql.Date(System.currentTimeMillis()));
				ps3.setString(4, "FL_SOCIAL_DUTY");
				ps3.setDouble(5, dispatch);
				ps3.setDouble(6, act.getCeshsum());
				ps3.setString(7, "Special Additional Duty For "+dispatch+" Bottles.");
				ps3.setString(8, gatepass);
...
public int getMaxIdBond() {
	...
	/*public boolean printDraftReport(GatepassToWholesale_20_21_active_action action) {
		...
		try {
			...
			reportQuery = " SELECT a.vch_undertaking_name, b.vch_gatepass_no,b.vehicle_driver_name,a.vch_wrk_add,"
					...
					+ " distillery.fl2_stock_trxn_20_21 c, distillery.brand_registration_20_21 d, distillery.packaging_details_20_21 e, distillery.box_size_details f "
					+ " WHERE a.int_app_id_f=b.int_dist_id AND b.int_dist_id=c.int_dissleri_id AND b.vch_gatepass_no=c.vch_gatepass_no "
					+ " and b.dt_date=c.dt AND c.int_brand_id=d.brand_id AND d.brand_id=e.brand_id_fk AND c.int_pckg_id=e.package_id "
			...
			if (rs.next()) {
				...
				GatepassToWholesale_20_21_active_dt dt = new GatepassToWholesale_20_21_active_dt();
				...
				new GatepassToWholesale_20_21_active_dt().setPrintFlag(false);
				printFlag = false;
			}
	...
	public void saveExcelData(GatepassToWholesale_20_21_active_action action) {
		String gatepass = "";
		...
		try {
			String sql = "INSERT INTO distillery.fl11_dislery_casecode_20_21(vch_gatepass_no, vch_casecode)VALUES (?, ?) ";
	...
	public ArrayList getExcelData(GatepassToWholesale_20_21_active_action action) {
		ArrayList list = new ArrayList();
	...
	public boolean getCascodeMatch(String casecode,String etin,Date date_plan,GatepassToWholesale_20_21_active_action action)
	{
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
	...
	public ArrayList displaylistImpl(GatepassToWholesale_20_21_active_action act, String val) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		try {
			...
			selQr = " SELECT liquor_type,quantity as qnt_ml_detail,a.cesh,a.code_generate_through,b.domain,a.package_name, a.package_id, a.duty, a.adduty, c.int_brand_id, b.brand_name,coalesce(c.tnt,'X') as tt , c.tnt ,"
	...
	// -----------list
	public ArrayList fromliclistImpl(GatepassToWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList toliclistImpl(GatepassToWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList toliclistImpl1a(GatepassToWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList toliclistImpl2a(GatepassToWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		list.add(item);
		try {
			String query = "SELECT distinct trim(vch_licence_no) as vch_licence_no FROM licence.fl2_2b_2d_20_21 WHERE vch_license_type='FL2A'  and vch_approval='A'";
			;
	...
	public String getDetails(GatepassToWholesale_20_21_active_action ac) {
		int id = 0;
		Connection con = null;
	...
	public ArrayList getSeasonDetails(GatepassToWholesale_20_21_active_action ac) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public int maxId(GatepassToWholesale_20_21_active_impl impl) {
	...
	public ArrayList getGatePassWholeSaleListManufacture(
			GatepassToWholesale_20_21_active_action action, Date ev) {
		ArrayList list = null;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		String query = " SELECT distinct int_dist_id, vch_distillary_name, vch_distillary_address, a.vch_gatepass_no, c.code_generate_through,a.export_lic_no,"
				...
				+ "   where  vch_to not in ('EOI')  and  a.int_dist_id="
				+ action.getDist_id()
	...
	public String saveBarImpl(GatepassToWholesale_20_21_active_action act) {
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		int tok1 = 0;
	...
	public ArrayList getbarcodeDetails(GatepassToWholesale_20_21_active_action act) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public boolean printReport(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
		...
		try {
			...
			reportQuery = "select int_dist_id, vch_distillary_name, dispatchd_box, vch_distillary_address, permit_dt, vch_permit_no,"+
					...
					" from distillery.fl11gatepass_draftfl1_20_21("+action.getDist_id()+",'"+Utility.convertUtilDateToSQLDate(action.getPrintDate())
			...
			reportQuery1 = "select int_dist_id, vch_distillary_name, dispatchd_box, vch_distillary_address, permit_dt, vch_permit_no,"+
					...
					" db_total_additional_duty, vch_root_details, vch_vehicle_no, int_dissleri_id, int_brand_id, no_bottl,"+
					" box_size, brand_id, brand_name, strength, valid_till, batch_no, package_name, box_id, ml, bl, al, vch_unit_name"+
					" from distillery.fl11gatepass_draftfl1a_20_21("+action.getDist_id()+",'"+Utility.convertUtilDateToSQLDate(action.getPrintDate())
					+"','"+action.getPrintGatePassNo().trim()+"')";
			reportQuery2 = "select int_dist_id, vch_distillary_name, dispatchd_box, vch_distillary_address, permit_dt, vch_permit_no,"+
					" vehicle_agency_and_address, vch_to, vch_from_lic_no, vch_from, vch_gatepass_no, dt_date, db_total_duty,"+
					" db_total_additional_duty, vch_root_details, vch_vehicle_no, int_dissleri_id, int_brand_id, no_bottl,"+
					" box_size, brand_id, brand_name, strength, valid_till, batch_no, package_name, box_id, ml, bl, al, vch_unit_name"+
					" from distillery.fl11gatepass_draftfl2a_20_21("+action.getDist_id()+",'"+Utility.convertUtilDateToSQLDate(action.getPrintDate())
					+"','"+action.getPrintGatePassNo().trim()+"')";
	...
	public boolean printDraft(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
	...
	public boolean printReportexp1(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
		...
		try {
			...
			reportQuery = " select int_dist_id, vch_distillary_name,dispatchd_box, vch_distillary_address, vch_auth_name, export_lic_no,"+
					...
					" from distillery.fl11gatepass_draftexp_20_21(" + action.getDist_id() + ", '"+
...
//System.out.println("reportQuery : printReportexp1="+reportQuery);
	...
	public boolean printReportexp(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
		...
		try {
			...
			reportQuery = " SELECT a.int_dist_id as int_brewery_id, a.vch_distillary_name as vch_brewery_name,b.dispatchd_box, a.vch_distillary_address as vch_brewery_address,"
					...
					+ " a.vch_distillary_name as vch_unit_name "
					+ " FROM distillery.gatepass_to_manufacturewholesale_20_21 a , distillery.fl1_stock_trxn_20_21 b , "
	...
	public boolean printReport1(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
	...
	public boolean updateFL3(GatepassToWholesale_20_21_active_action act) {
		int save = 0;
		int j[] = null;
		boolean val = false;
		PreparedStatement ps = null;
		...
		try {
			...
			for (int i = 0; i < act.getGetVal().size(); i++) {
				GatepassToWholesale_20_21_active_dt dt = (GatepassToWholesale_20_21_active_dt) act
						.getGetVal().get(i);
	...
	public int recieveCases(GatepassToWholesale_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public int excelCases(GatepassToWholesale_20_21_active_action act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public boolean printReportexp1Draft(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
	...
	public boolean printReport1Draft(GatepassToWholesale_20_21_active_action action,
			GatepassToWholesale_20_21_active_dt dt) {
	...
	/*
	 * public void saveCSV(GatepassToWholesale_20_21_active_action action)throws IOException {
	...
	public int maxIdSeq(GatepassToWholesale_20_21_active_impl impl) {
	...
	public String cancel_gatepassImpl(GatepassToWholesale_20_21_active_action act,String vch, String vch_to_lic)
	{
	...
	public boolean  etin(String casecode,String size,GatepassToWholesale_20_21_active_action act) {
	...
	public boolean getSize(String size,String etin,GatepassToWholesale_20_21_active_action action)
	{
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		boolean flag=false;
		String sql="select * from distillery.fl1_stock_trxn_20_21 where size::numeric="+size+" and code_generate_through='"+etin+"'";
...
//-----------------------------------------------------------------------------------
	  ...
	  public boolean checkDate(GatepassToWholesale_20_21_active_action act) {
			...
			try {
				...
				query =" select  vch_finalize,dt_date from distillery.gatepass_to_manufacturewholesale_20_21 "+
