...
public class CommonImpl {
	public static ArrayList finYrlist()
	{
		...
		"	select id,year from public.financial_year_master "+
		"	where flg='a'" ;
...
public static  ArrayList getDistillery() {
		...
		ArrayList list=new ArrayList();
			...
			try
			{
			String query = " select int_app_id_f,vch_undertaking_name  FROM  public.dis_mst_pd1_pd2_lic where vch_verify_flag='V'";
...
public static String getEmailUser() {
	...
	try {
		String query = "SELECT D.vch_email_id FROM COMMON_EMAIL_ACTION D  ";
...
public static String getEmailUserPassword() {
	...
	try {
		...
		String query = "SELECT D.vch_password FROM  COMMON_EMAIL_ACTION D  ";
...
public static void sendEmail(String to, String sub, String msg,
		String txtfrom, String txtpassword) {
