...
public  static String getUserNameAllReq(){
	...
	ResultSet rs =null;
		...
		try {	
		String queryList="SELECT coalesce(vch_wrk_phon,'0') as logusr  from  public.loginmap where virtuallogin='"+userName+"'";
...
public static String encryptMD5vivek(String pass) {
