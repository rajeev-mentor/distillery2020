 ...
 */    
	...
	public static boolean validateCompareDatesLesser(String aDateName,java.util.Date aDate,String bDateName,java.util.Date bDate)
	{
	  ...
	  public static boolean validateOnlyLongInteger(String nameToCheck,Long a)
	 	{
	 		boolean bool= true;
	 		if(a ==0)
	  	    {ResourceUtil.addErrorMessage(nameToCheck,Constants.ONLY_INT);bool=false;return bool;}
		...
		public static boolean validateOnlyDoubleRequired1(String nameToCheck,double stringToCheck)
		{
			boolean bool= true;
			if (stringToCheck>0.0) { // You can use the `\\d` instead of `0-9` too!
			    // Is a number - int, float, double    
				
			}else{
				ResourceUtil.addErrorMessage(nameToCheck,Constants.bl);bool=false;return bool;
			}
		...
		public static boolean validateOnlyDoubleRequired2(String nameToCheck,double stringToCheck)
		{
			boolean bool= true;
			if (stringToCheck>0.0) { // You can use the `\\d` instead of `0-9` too!
			    // Is a number - int, float, double    
				...
				ResourceUtil.addErrorMessage(nameToCheck,Constants.blwater);bool=false;return bool;
			}
		...
		public static boolean validateOnlyDoubleRequired3(String nameToCheck,double stringToCheck)
		{
			boolean bool= true;
			if (stringToCheck>0.0) { // You can use the `\\d` instead of `0-9` too!
			    // Is a number - int, float, double    
				...
				ResourceUtil.addErrorMessage(nameToCheck,Constants.tot_str);bool=false;return bool;
			}
