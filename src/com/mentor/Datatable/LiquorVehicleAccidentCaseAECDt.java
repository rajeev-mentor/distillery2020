...
public class LiquorVehicleAccidentCaseAECDt {
	...
	private int box_size,int_liquor_type,dispatch_bottls;
	private int dispatch_box;
	private int dispatch_bottle,showDataTable_breakgae;
	private String license_type,vch_from,license_no,distillery_name,pdfname,maped_unmaped_flag,code_generate_through,seqform,seqto,caseseq,finalized_falg;
	...
	public int getDispatch_bottls() {
		return dispatch_bottls;
	}
	public void setDispatch_bottls(int dispatch_bottls) {
		this.dispatch_bottls = dispatch_bottls;
	}
