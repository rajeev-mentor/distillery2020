 ...
 <link  href ="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.min.css"  rel="stylesheet" type="text/css"> 
	...
	<div align="center" class="heading1">				
			...
			<rich:spacer height="10px"></rich:spacer>
					...
					<rich:dataTable id="table22" rows="15" var="list22"
						...
						<rich:column align="center">
							...
							rendered="#{list22.check_pdf==false}"
						...
						<rich:column rendered="#{eoiExportOrderFrorwardingAction.radio eq 'D'}">
									<f:facet name="header">
				...
				<div class="col-md-3" align="right">
						...
						<div class="col-md-3" align="right">
							...
							<div class="col-md-3" align="left" style = "width:300px;">
                            <h:inputText value = "#{eoiExportOrderFrorwardingAction.performa_invoice_no}"
							 styleClass="form-control" style="color: #000000" readonly = "true"/>								
							</div>
							
					
						<div class="col-md-3" align="right">
							<h:outputText value="Uploaded Certificate : "
								style="FONT-WEIGHT: bold; font-size: 15px;FONT-FAMILY: 'Candara Light';"></h:outputText>
			...
			<div>		
				...
				<a4j:outputPanel rendered="#{eoiExportOrderFrorwardingAction.rejection_flg eq 'T' and eoiExportOrderFrorwardingAction.radio eq 'N' and eoiExportOrderFrorwardingAction.user4_flag}">
<div class="row" align="center">
						...
						<div class="col-md-2">
						<h:selectOneMenu value="#{eoiExportOrderFrorwardingAction.objectionRejectionCode}" styleClass="form-control">
						<f:selectItems value="#{eoiExportOrderFrorwardingAction.rejectionList}"/>
						</h:selectOneMenu>
						</div>
						<div class="col-md-4"></div>
						</div>
