		...
		<h:form>
			...
			<div class="row">
				<div align="center">
					...
					<h:inputHidden
						value="#{transfer_Of_Sprit_To_Blending_VatAction.hidden}"></h:inputHidden>
			...
			<div class="co-md-12 row">
				...
				<div class="col-md-3" align="right">
					<rich:calendar
						value="#{transfer_Of_Sprit_To_Blending_VatAction.currentDate}"
			...
			<div class="co-md-12 row">
				...
				<div class="col-md-3" align="right">
					<h:selectOneMenu styleClass="form-control"
						...
						valueChangeListener="#{transfer_Of_Sprit_To_Blending_VatAction.spirit_vatListner}"
						value="#{transfer_Of_Sprit_To_Blending_VatAction.spirt_no}">
						<f:selectItems
							value="#{transfer_Of_Sprit_To_Blending_VatAction.spirt_noList}" />
				...
				<div class="col-md-2" align="right">
					<h:inputText
						value="#{transfer_Of_Sprit_To_Blending_VatAction.spirt_bl}"
				...
				<div class="col-md-2" align="right">
					<h:inputText
						value="#{transfer_Of_Sprit_To_Blending_VatAction.spirt_al}"
						styleClass="form-control" disabled="true">
					</h:inputText>
				</div>
			...
			<div class="co-md-12 row">
				...
				<div class="col-md-3" align="right">
					<h:selectOneMenu styleClass="form-control"
						onchange="this.form.submit();"
						valueChangeListener="#{transfer_Of_Sprit_To_Blending_VatAction.blendinglistner}"
						value="#{transfer_Of_Sprit_To_Blending_VatAction.blend_vat_no}">
						<f:selectItems
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blend_vat_noList}" />
			...
			<div class="newsdiv">
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="left">
						<h:outputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_bl}"
					...
					<div class="col-md-2" align="left">
						<h:outputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_al}"
							styleClass="form-control">
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="left">
						<h:inputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_bl_bfr}"
							styleClass="form-control">
					...
					<div class="col-md-2" align="left">
						<h:inputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_strngth_bfr}"
							styleClass="form-control">
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="dutyPay1">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_al_bfr}"
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="left">
						<h:inputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_bl_aftr}"
							styleClass="form-control">
					...
					<div class="col-md-2" align="left">
						<h:inputText
							value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_strnght_aftr}"
							styleClass="form-control">
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="dutyPay2">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_al_aftr}"
								styleClass="form-control" readonly="true">
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="blending_bl_wast">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_bl_wast}"
								styleClass="form-control">
							</h:outputText>
						</a4j:outputPanel>
					</div>
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="blending_al_wast">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_al_wast}"
								styleClass="form-control">
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="blending_bl_trnfr">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_bl_trnfr}"
								styleClass="form-control">
					...
					<div class="col-md-2" align="left">
						<a4j:outputPanel id="blending_al_trnfr">
							<h:outputText
								value="#{transfer_Of_Sprit_To_Blending_VatAction.blending_al_trnfr}"
								styleClass="form-control">
			...
			<div class="col-md-12 row">
				<div align="center">
					...
					<h:commandButton class="btn btn-primary"
						action="#{transfer_Of_Sprit_To_Blending_VatAction.saveMethod}"
						value="Save"></h:commandButton>
					<rich:spacer width="10px"></rich:spacer>
					<h:commandButton class="btn btn-info"
						action="#{transfer_Of_Sprit_To_Blending_VatAction.reset}"
			...
			<div class="row" align="center">
				<rich:dataTable columnClasses="columnClass1" headerClass="TableHead"
					...
					rows="20" width="80%"
					value="#{transfer_Of_Sprit_To_Blending_VatAction.saveData}"
					var="list">
					<f:facet name="header">
						<h:outputText
