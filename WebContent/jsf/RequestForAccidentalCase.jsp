	...
	height:30px;
     ...
     <div class="row">
      ...
      <h:messages errorStyle="color:red" layout="table"
       ...
       <rich:spacer  height="30"></rich:spacer>
       <h:inputHidden value="#{requestForAccidentalCaseAction.hidden}" />
                            <div align="center"><h:outputText
										value="Request For Accidental Case"
							 ...
							 <div align="center">
							  <h:outputText value="#{requestForAccidentalCaseAction.name}" style="FONT-SIZE: large;"></h:outputText>
							 </div>
							  <rich:spacer  height="10"></rich:spacer>
							  <div align="center">
							  <h:outputText value="#{requestForAccidentalCaseAction.address}" style="FONT-SIZE: medium;"></h:outputText>
							 </div>
							  <rich:spacer  height="30"></rich:spacer>
							 ...
							 <div >
							   <TABLE align="center" class="table1">
							    <TR style="margin: 5px;">
							     ...
							     <TD><h:selectOneMenu value="#{requestForAccidentalCaseAction.gatepass_type}" styleClass="dropdown-menu">
							       <f:selectItem itemValue="" itemLabel="--Select--"/>
							      <f:selectItem itemValue="CL" itemLabel="CL"/>
							      <f:selectItem itemValue="FL3" itemLabel="FL3/3A"/>
							      <f:selectItem itemValue="FL1" itemLabel="FL1/1A"/>
							     </h:selectOneMenu> </TD>
							     <TD style="text-align: right"><h:outputText value="Gatepass No.:"></h:outputText></TD>
							      <TD><h:inputTextarea value="#{requestForAccidentalCaseAction.gatepass_no}"></h:inputTextarea></TD>
							      <TD style="text-align: right"><h:outputText value="Gatepass Date :"></h:outputText></TD>
							      <TD style="text-align: left;width:50px"><rich:calendar  value="#{requestForAccidentalCaseAction.gatepass_date}"></rich:calendar> </TD>
							    ...
							    <TR style="margin-top: 10px;">
							     ...
							     <TD><h:inputTextarea value="#{requestForAccidentalCaseAction.accident_address}"></h:inputTextarea> </TD>
							     <TD style="text-align: right"><h:outputText value="Accident Location District:"></h:outputText></TD>
							      <TD><h:selectOneMenu value="#{requestForAccidentalCaseAction.accident_district_id}" styleClass="dropdown-menu">
						         <f:selectItems value="#{requestForAccidentalCaseAction.accident_district_list}"/>
							     </h:selectOneMenu> </TD>
							      <TD style="text-align: right"><h:outputText value="Accident  Date :"></h:outputText></TD>
							      <TD><rich:calendar  value="#{requestForAccidentalCaseAction.accident_date}"></rich:calendar> </TD>
							    </TR>
				 ...
				 <div class="row">   
				  <rich:spacer height="30"></rich:spacer>
							 ...
							 <div align="center">
							   <h:commandButton value="Save" action="#{requestForAccidentalCaseAction.save}" style="margin:0px 5px;"
							   styleClass="btn btn-success btn-sm"></h:commandButton>
							   <h:commandButton value="Reset" action="#{requestForAccidentalCaseAction.reset}" style="margin:0px 5px;"
					...
					<rich:dataTable id="table22" rows="15" var="list"
						value="#{requestForAccidentalCaseAction.display_list}" styleClass="table table-hover"
