			...
			<div class="container" style="width: 100%; 	">
				<div class="row">
					...
					<div class="row" align="center">
						<div class="col-md-12">
							<h:outputLabel value="Prepration Of Blend FL3 "
								style="text-align:center;font-family:Calibri;font-weight:bold;font-size:35px;COLOR: #0000a0;" />
							<h:inputHidden value="#{prepration_of_Blend_FL3_act.hidden}"></h:inputHidden>
						</div>
					</div>
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-3" align="right">
						<h:selectOneMenu value="#{prepration_of_Blend_FL3_act.storageId}"
							valueChangeListener="#{prepration_of_Blend_FL3_act.blntanklistnerMF4 }"
							onchange="this.form.submit();" styleClass="form-control">
							<f:selectItems value="#{prepration_of_Blend_FL3_act.storage}" />
							<a4j:support event="onchange"
								actionListener="#{prepration_of_Blend_FL3_act.calculateBillAmt}">
							</a4j:support>
						</h:selectOneMenu>
					</div>
					...
					<div class="col-md-2" align="right" >
						<h:inputText value="#{prepration_of_Blend_FL3_act.blendingbl}" disabled="true">
					...
					<div class="col-md-2" align="right">
						<h:inputText value="#{prepration_of_Blend_FL3_act.blendingal}" disabled="true">
							<a4j:support event="onblur" reRender=" bl"></a4j:support>
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-3" align="right">
						<h:inputText value="#{prepration_of_Blend_FL3_act.bl }">
							<a4j:support event="onblur" reRender=" bl"></a4j:support>
						</h:inputText>
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-3" align="right">
						<h:inputText value="#{prepration_of_Blend_FL3_act.blwater }">
							<a4j:support event="onblur" reRender=" bl"></a4j:support>
						</h:inputText>
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-2" align="right">
						<a4j:outputPanel id="bl">
							<h:inputText value="#{prepration_of_Blend_FL3_act.tot_bl}" disabled="true">
					...
					<div class="col-md-2" align="right">
						<a4j:outputPanel id="tot_bl">
							<h:inputText value="#{prepration_of_Blend_FL3_act.tot_str}">
								<a4j:support event="onblur" reRender=" abl"></a4j:support>
							</h:inputText>
						</a4j:outputPanel>
					</div>
					...
					<div class="col-md-2" align="right">
						<a4j:outputPanel id="abl">
							<h:inputText value="#{prepration_of_Blend_FL3_act.tot_al}" disabled="true">
			...
			<div style="width: 100%; ">
				<div align="center">
					<h:commandButton value="Save" styleClass="btn btn-primary"
						action="#{prepration_of_Blend_FL3_act.save }">
					</h:commandButton>
					<rich:spacer width="10px"></rich:spacer>
					<h:commandButton styleClass="btn btn-primary"
						action="#{prepration_of_Blend_FL3_act.reset}" value="Reset"></h:commandButton>
				</div>
			...
			<div class="row" style="width: 100%;" align="center">
				<div class="col-md-12">
					<rich:dataTable columnClasses="columnClass1"
						...
						value="#{prepration_of_Blend_FL3_act.displaylist}" var="list">
						<rich:column>
							<f:facet name="header">
