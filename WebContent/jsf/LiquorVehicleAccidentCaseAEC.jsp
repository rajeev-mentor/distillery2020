	...
	height:30px;
     ...
     <div class="row">
      ...
      <h:messages errorStyle="color:red" layout="table"
       ...
       <rich:spacer  height="30"></rich:spacer>
       <h:inputHidden value="#{liquorVehicleAccidentCaseAECAction.hidden}" />
                            <div align="center"><h:outputText
										value="Liquor Vehicle Accidental Case Verification"
							 ...
							 <rich:spacer  height="30"></rich:spacer>
								...
								<div class="col-md-12" align="center">
									<h:selectOneRadio style="width:25%"
										value="#{liquorVehicleAccidentCaseAECAction.radioType}"
										valueChangeListener="#{liquorVehicleAccidentCaseAECAction.changelist}"
							...
							<div class="row">
							 ...
							 <h:panelGroup rendered="#{liquorVehicleAccidentCaseAECAction.viewflag == false}">
							 <div align="center">
					<rich:dataTable id="table22" rows="15" var="list"
						value="#{liquorVehicleAccidentCaseAECAction.display_list}" styleClass="table table-hover"
						...
						<rich:column align="center"  rendered="#{liquorVehicleAccidentCaseAECAction.radioType eq 'A'}">
							<f:facet name="header">
						...
						<rich:column align="center">
							...
							<h:commandButton value="View" styleClass="btn btn-info btn-sm" actionListener="#{liquorVehicleAccidentCaseAECAction.view}"></h:commandButton>
							...
							<h:commandButton value="Receive" styleClass="btn btn-success btn-sm" actionListener="#{liquorVehicleAccidentCaseAECAction.genrateBarcode}"></h:commandButton>
					   ...
					   <f:facet name="footer">
						...
						<h:panelGroup rendered="#{liquorVehicleAccidentCaseAECAction.viewflag}">	
							 <rich:spacer  height="30"></rich:spacer>
							 <div class="main">
						<div>
<table class="table table-hover table-striped table-bordered"  style="width: 100%;">
											<tr>
												...
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.gatepass_type}" /></td>
														<td style="width: 150px; padding: 10px;"><h:outputText
														value="Gatepass No. " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.gatepass_no}" /></td>
															<td style="width: 150px; padding: 10px;"><h:outputText
														value="Gatepass Date . " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.gatepass_date}" /></td>
											...
											<tr>
												...
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.accident_address}" /></td>
														<td style="width: 150px; padding: 10px;"><h:outputText
														value="Accident Location District:" /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.accident_district_name}" /></td>
															<td style="width: 150px; padding: 10px;"><h:outputText
														value="Accident  Date :" /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.accident_date}" /></td>
											...
											<tr>
												<td style="width: 150px; padding: 10px;"><h:outputText
														value="License No: " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licenseNo}" />
												</td>
												
													<td style="width: 150px; padding: 10px;"><h:outputText
														value="License Name:" /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licenseNm}" />
												</td>
												
													<td style="width: 150px; padding: 10px;"><h:outputText
														value="Driver Name: " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.driverNm}" />
												</td>
											...
											<tr>
												...
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licenseAddrss}" /></td>
														<td style="width: 150px; padding: 10px;"><h:outputText
														value="License Root details : " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licenserootDetails}" /></td>
															<td style="width: 150px; padding: 10px;"><h:outputText
														value="Inpection Report : " /></td>
												<td style="width: 300px; text-align: left;"><h:outputLink
														value="/doc/ExciseUp/WholeSale/pdf/#{liquorVehicleAccidentCaseAECAction.gatepass_no}_new.pdf"
														target="_blank">
											...
											<tr>
												<td style="width: 150px; padding: 10px;"><h:outputText
														value="Vehicle No : " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.vehcleNo}" /></td>
																<td style="width: 150px; padding: 10px;"><h:outputText
														value="Agency Address: " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.vehicaleagecyAdd}"/></td>
							 	...
							 	<div class="row" align="center">
										<table class="table table-hover table-striped table-bordered"  style="width: 80%;">
											<tr>
												...
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.date_list}" /></td>
													
	<td style="width: 150px; padding: 10px;"><h:outputText
														value="License Type : " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licensetype_list}" /></td>
											...
											<tr>
												...
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.gatapassNo_list}" />
												</td>
												<td style="width: 150px; padding: 10px;"><h:outputText
														value="License No : " /></td>
												<td style="width: 300px; text-align: left;"><h:outputText
														value="#{liquorVehicleAccidentCaseAECAction.licenseno_list}" /></td>
					...
					<rich:dataTable id="table23"  var="list22"
						value="#{liquorVehicleAccidentCaseAECAction.brand_list}" styleClass="table table-hover"
						width="100%" headerClass="TableHead" footerClass="TableHead"
					...
					<div align="center">
							   <h:commandButton value="Accept" action="#{liquorVehicleAccidentCaseAECAction.verfy}" 
							   disabled="#{liquorVehicleAccidentCaseAECAction.radioType eq 'A'}" style="margin:0px 5px;"
							   styleClass="btn btn-success btn-sm"></h:commandButton>
							      <h:commandButton value="Reject" action="#{liquorVehicleAccidentCaseAECAction.reject}" 
							      disabled="#{liquorVehicleAccidentCaseAECAction.radioType eq 'A'}" style="margin:0px 5px;"
							   styleClass="btn btn-success btn-sm"></h:commandButton>
							   <h:commandButton value="Back" action="#{liquorVehicleAccidentCaseAECAction.back}" style="margin:0px 5px;"
							   styleClass="btn btn-warning btn-sm"></h:commandButton>
							 </div>
							 </h:panelGroup>
							 <h:panelGroup rendered="#{liquorVehicleAccidentCaseAECAction.barcode_flag}">
							 
							 <div align="center" style="margin: 15px;text-decoration: blink; color:red;"><h:outputText value="You can generate one time QR/Bar code of SKU in a gatepass" /></div>
							 <div >
							 <rich:dataTable columnClasses="columnClass1"
													headerClass="TableHead" footerClass="TableHead"
													rowClasses="TableRow1,TableRow2" styleClass="DataTable"
													id="table2" rows="10" width="100%"
													value="#{liquorVehicleAccidentCaseAECAction.showDataTableList}" var="list11" >
													...
													<rich:column>
														<f:facet name="header">
															<h:outputText value=" Bottels For Barcode" width="60px">
															</h:outputText>
														</f:facet>
														<h:inputText value="#{list11.dispatch_bottls}" disabled="#{list11.finalized_falg eq 'F' or list11.finalized_falg eq 'N'}" 
													...
													<rich:column>
														...
														<h:commandButton actionListener="#{liquorVehicleAccidentCaseAECAction.finalizeData}" 
														...
														<h:commandButton actionListener="#{liquorVehicleAccidentCaseAECAction.receive}" 
